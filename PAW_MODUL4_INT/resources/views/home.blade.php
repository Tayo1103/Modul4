...
<div class="bg-white p-6 rounded shadow mb-4">
    @auth
        <h1 class="text-2xl font-semibold mb-2">Welcome, {{ Auth::user()->name }}! You have successfully logged in.</h1>
        ...
        <p class="text-gray-700 mb-4">Get the latest updates and news about Telkom University here!</p>
        ...
        @endif
    @else
        <h1 class="text-2xl font-semibold mb-2">Welcome to SeputarTelkom!</h1>
        <p class="text-gray-700">Please login to get the best experience.</p>
    @endauth
</div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @forelse ($articles as $article)
            <div class="block bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-200">
                ...
                <a href="{{ route('articles.show', $article->id) }}" class="hover:underline text-blue-600 font-medium">Read More</a>
            </div>
        @empty
