...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('admin.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
        ...
        @method('PUT')
        <div class="mb-4">
            <label for="title" class="block text-gray-700 text-sm font-medium mb-2">Article Title</label>
        ...
        <div class="mb-4">
            <label for="content" class="block text-gray-700 text-sm font-medium mb-2">Article Content</label>
        ...
        <div class="mb-4">
            <label for="image" class="block text-gray-700 text-sm font-medium mb-2">Article Image</label>
...
<script>
    function previewImage(event) {
        ...
        if (file) {
            ...
            message.innerHTML = 'New Image Preview:';
        } else {
