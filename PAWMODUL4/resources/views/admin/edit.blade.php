...
<div class="container mx-auto p-6">
    ...
    <form method="POST" action="{{ route('admin.update', $article) }}" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            <label for="image" class="block text-gray-700 text-sm font-medium mb-2">Foto Artikel</label>
